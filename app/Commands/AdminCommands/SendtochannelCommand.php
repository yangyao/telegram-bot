...
class SendtochannelCommand extends AdminCommand
{
     ...
     * Conversation Object
     *
     * @var \Yangyao\TelegramBot\Conversation
     */
     ...
     *
     * @return \Yangyao\TelegramBot\Entities\ServerResponse|mixed
    ...
    public function execute()
    {
        ...
        // Conversation
        $this->conversation = new Conversation($this->telegram, $user_id, $chat_id, $this->getName());
    ...
    protected function sendBack(Message $message, array $data)
    {
        ...
        $callback_path     = 'Yangyao\TelegramBot\Request';
